...
from intercambio import procesar_voids_paralelo, contar_estados, intercambiar_bloques_numba, actualizar_probabilidades, calcular_vecinos, calcular_indices_extraccion, calcular_vecinos_paralelo, elegir_direccion
